...
public class Node
{
    ...
    public double getTotalCost(int goalX, int goalY)
    {
        ...
        return _depth + directLineDistance * AIStarPerfTest.WEIGHT; // 15 is the fastest weight after several random tests, but 5 is a lot more accurate and only about 10% slower.
    }
